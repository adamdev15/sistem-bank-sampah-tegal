...
@section('breadcrumb', 'Data Wilayah / Kelurahan')

@section('content-body')
<div class="verification-layout">
    <div class="verification-stats">
        <div class="verify-stat-card total">
            <div class="verify-icon"><i class="fas fa-map-pin"></i></div>
            <div><h3>{{ $kelurahans->count() }}</h3><p>Total Kelurahan</p></div>
        </div>
...
<form id="kelurahanDeleteForm" method="POST" style="display:none;">
    @csrf
    @method('DELETE')
</form>
        ...
        btn.addEventListener('click', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const form = document.getElementById('kelurahanDeleteForm');
